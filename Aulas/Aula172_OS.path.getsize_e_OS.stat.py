...
caminho = os.path.join('\\Users', 'DELL', 'Documents', 'UDEMY', 'Exemplo') 
...
for root, dirs, files in os.walk(caminho): 
    ...
    for file_ in files: 
        ...
        # tamanho = os.path.getsize(caminho_completo_arquivo) #mostra o tamanho do arquivo em bites
        stats = os.stat(caminho_completo_arquivo)
        tamanho = stats.st_size # essa linha (51) e a 50, fazem a mesma coisa que a linha 49
