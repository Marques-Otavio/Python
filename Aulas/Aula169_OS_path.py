...
print(caminho)
diretorio, arquivo = os.path.split(caminho) #divide em uma tupla com diretorio e arquivo
nome_arquivo, extensao_arquivo = os.path.splitext(arquivo) #divide o nome do arquivo e sua extensao(ex: .txt)
print(nome_arquivo, extensao_arquivo)
print(os.path.exists(caminho)) #verifica se o caminho existe no meu pc
print(os.path.abspath('.')) #retorna o caminho absoluto de um arquivo, o '.' significa que é o deste próprio
print(os.path.basename(caminho)) #pega a parte final do diretório
print(os.path.dirname(caminho)) #pega somente a parte do diretorio, deixando o arquivo em si de lado